...
source_group(TREE ${CMAKE_CURRENT_SOURCE_DIR}/Source PREFIX "" FILES ${${PROJECT_NAME}_sources})
...
foreach (target ${FORMATS} "All")
    if (TARGET ${PROJECT_NAME}_${target})
        ...
        if (NOT target STREQUAL "All")
            set_target_properties(${PROJECT_NAME}_${target} PROPERTIES
                XCODE_SCHEME_EXECUTABLE "${CMAKE_CURRENT_SOURCE_DIR}/ext/JUCE/extras/AudioPluginHost/Builds/MacOSX/build/Debug/AudioPluginHost.app")
        endif ()
    endif ()
endforeach ()
